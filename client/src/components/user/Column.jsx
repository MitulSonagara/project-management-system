...
const Column = ({ color, name, id, tasks, submitNewTask, handleTaskDelete, submitNewComment, projectId, tasksList }) => {
    ...
    return (
        <div className="flex flex-col">
            <div className="relative px-4 flex justify-between h-10 w-[340px] items-center rounded-xl bg-white font-medium text-black dark:bg-black dark:text-white">
                <div

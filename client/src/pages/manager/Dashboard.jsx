...
import { getDashboard, getDashboardTable } from '../../redux/Slices/manager/dashboardSlice';
import { Card, CardBody, CardHeader, Typography, Avatar, Tooltip, Progress } from '@material-tailwind/react';

export const Dashboard = () => {

  const dispatch = useDispatch()
  const dashboardData = useSelector((state) => state.managerDashboard);
  const tableData = useSelector((state) => state.managerDashboard.tableData);

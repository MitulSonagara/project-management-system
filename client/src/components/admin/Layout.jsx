...
import { Home, Briefcase, CalendarCheck, ChartAreaIcon, MessageCircle } from 'lucide-react';
...
const adminSidebarMenuItems = [
    ...
    },
    {
        ...
        icon: <ChartAreaIcon className="h-6 w-6 text-gray-800 dark:text-gray-100" />
    },
    {
        label: "Chat",
        path: "/admin/chat",

        ...
        <>
            ...
            <Dialog open={open} handler={handleOpen} className='overflow-auto h-3/4'>
                <div className="max-w-4xl mx-auto p-4">
                    ...
                    <p className="text-gray-800 font-medium mb-4">{task.description || "No description provided."} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores, delectus!
                    </p>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-800">{task.state}</p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-800">Due Date</h3>
                            <p className="text-gray-800">{task.dueDate ? new Date(task.dueDate).toLocaleDateString() : "Not set"}</p>
                        </div>
                    </div>
                            ...
                            {task.assignees.length > 0 ? (
                                task.assignees.map((assignee, index) => (
                                    <div key={index} className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-gray-800 font-medium">{assignee.name}</p>
                                            <Typography variant="small" color="gray" className="font-normal">
                                                {assignee.email}
                                            </Typography>
                                        </div>
